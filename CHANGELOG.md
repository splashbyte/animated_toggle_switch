...
- adds possibility that no valid value is selected (by setting `preventUnknownValues` to `false`)
- adds new parameters to almost all constructors: `preventUnknownValues`, `indicatorAppearingBuilder`, `indicatorAppearingAnimationDuration`, `indicatorAppearingAnimationCurve`
